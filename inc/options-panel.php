    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'social_profiles',
                'type'     => 'sortable',
                'title'    => __( 'Past your Social Profiles', 'redux-framework-demo' ),
                'label'    => true,
                'options'  => array(
                    'Facebook Profile'   => '',
                    'Twiter Profile'     => '',
            ...
            array(
                ...
                'type'       => 'media',
                'url'        => true,
                'title'      => __( 'Inner Header Image', 'redux-framework-demo' ),
                'compile'    => 'true',
            ),
            ...
            array(
                'id'       => 'book_url',
                'type'     => 'text',
                'title'    => __( 'Book URL for Inner Pages', 'redux-framework-demo' ),
                'default'  => '#',
            ),
